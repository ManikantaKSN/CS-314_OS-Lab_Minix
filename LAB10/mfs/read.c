...
static void removeInodeEntry(struct inode *rip); //lab 10
...
int fs_readwrite(void)
{
  ...
  if(immediate == 1) {
    if(rw_flag == READING) {
      printf("MINIX 210010050 210010030: Reading from Immediate File.\n");
      ...
      printf("MINIX 210010050 210010030: File Contents of Immediate File:\n");
      for(i = 0; i < f_size; ++i) {
        printf("%c", buffer[i]);
      }
      printf("MINIX 210010050 210010030: EOF - Immediate File\n");
      ...
      printf("MINIX 210010050 210010030: Writing to Immediate File.\n");
      vir_bytes zone;
